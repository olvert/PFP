// Example 68 from page 51 of Java Precisely third edition (The MIT Press 2016)
...
class Example68 {
  ...
  private static void methodReferenceExamples() {
    ...
    Function<Integer,ArrayList<Double>> mkDoubleList = ArrayList<Double>::new;
    BiConsumer<Double[],Comparator<Double>> sorter = Arrays::<Double>sort;
    ArrayList<Double> list = mkDoubleList.apply(10);
    list.add(34.5); list.add(67.2); list.add(12.9);
    Double[] a = make1DArray.apply(list.size());
    list.toArray(a);
    sorter.accept(a, Comparator.<Double>naturalOrder());
  ...
  static class C extends B {
    ...
    public Supplier<Integer> getBVal() { return super::getVal; }
    public Supplier<Integer> getCVal() { return this::getVal; }
