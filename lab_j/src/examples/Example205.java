// Example 205 from page 171 of Java Precisely third edition (The MIT Press 2016)
...
class Example205 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (server) {               // Server: accept questions about primality
      ...
      System.out.println("   java Example205 server");
      System.out.println("   java Example205 client <serverhostname>");
      System.out.println("Use `java Example205 client localhost' if the"); 
